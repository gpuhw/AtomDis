...
const optab_t optable[256] = {
    ...
    { op_destsrc, "<!doc> SHL", D_REG, 0, 0 },
    { op_destsrc, "<!doc> SHL", D_PS, 0, 0 },
    { op_destsrc, "<!doc> SHL", D_WS, 0, 0 },
    { op_destsrc, "<!doc> SHL", D_FB, 0, 0 },
    { op_destsrc, "<!doc> SHL", D_PLL, 0, 0 },
    { op_destsrc, "<!doc> SHL", D_MC, 0, 0 },
    { op_destsrc, "<!doc> SHR", D_REG, 0, 0 },
    { op_destsrc, "<!doc> SHR", D_PS, 0, 0 },
    { op_destsrc, "<!doc> SHR", D_WS, 0, 0 },
    { op_destsrc, "<!doc> SHR", D_FB, 0, 0 },
